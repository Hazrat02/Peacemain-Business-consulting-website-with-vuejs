...
<template>
  <HomeLayout>
    <div id="body" class="tt-smooth-scroll tt-magic-cursor">
    ...
    >
        ...
        <div class="container-fluid one pl--95">
          <div class="details-page-content mb-70">
            ...
            <div class="row g-lg-4 gy-2">
              <div class="col-lg-6">
                <p class="first-para">
                  H ealth and care consulting refers to a specialized field of
                  consulting that focuses on providing advisory and support
                  services to organizations and individuals within the
                  healthcare and healthcare-related industries. This can
                  encompass a wide range of services and expertise aimed at
                  improving the delivery, efficiency, quality, and outcomes of
                  healthcare services and patient.Health and care consultants
                  bring specialized knowledge and expertise in healthcare
                  management, policy, technology, and clinical practice. They
            ...
            <div class="row g-md-4 gy-5">
              <div class="col-lg-3 col-md-4">
                <div class="solution-img">
                  <img
                    src="./../assets/frontend/img/inner-pages/service-details-solution-img.jpg"
                    alt
                  />
                </div>
              </div>
              <div class="col-lg-9 col-md-8">
                <div class="solution-content">
                  ...
                  <a class="primary-btn1 btn-hover" href="contact.html">
                    Get in Touch
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      width="12"
            ...
            <div class="row g-lg-4 gy-5">
              <div class="col-lg-8">
                <div class="advantage-content">
                  ...
                  <p>
                    Health and care consulting offers several advantages for
                    healthcare organizations, providers, and stakeholders. These
                    advantages can help improve the quality of healthcare
                    services, enhance operational efficiency, and address
                    complex challenges within the healthcare industry.
                  </p>
                    ...
                    <div class="details-counter-area">
                      ...
                      <div class="content">
                        <div class="content-top">
                          ...
                          <Counter :count="70" label="Customer Satisfaction" :extra="'%'" />
              ...
              <div class="col-lg-4">
                <div class="advantage-img">
                  <img
                    src="./../assets/frontend/img/inner-pages/service-details-advantage-img.jpg"
                    alt
                  />
                </div>
              </div>
      ...
      <div class="service-details-faq-section">
                    ...
                    <div class="accordion" id="accordionExample">
                      <div class="accordion-item">
                        ...
                        >
                          <div class="accordion-body">
                            Health and care consulting is a specialized service
                            that provides advisory and support to healthcare
                            organizations and stakeholders to improve
                      ...
                      <div class="accordion-item">
                        <h2 class="accordion-header" id="headingTwo">
                          ...
                          >
                            Why do healthcare organizations need consulting
                            services?
                          </button>
                        </h2>
                        <div
                      ...
                      <div class="accordion-item">
                        <h2 class="accordion-header" id="headingFour">
                          ...
                          >
                            How do you measure the success of a consulting
                            project?
                          </button>
                        </h2>
                        <div
